% The function to detect the groups of the largest circles in input image.
% Input is a binary image and the approximated radius of circles.
% Output is a image to show the positions of the largest circles
% in input image.
function largest_circle_img = detect_largest_circle(img, radius)
